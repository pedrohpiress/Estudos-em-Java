...
import com.example.api.domain.paciente.DadosCadastroPaciente;
...
class MedicoRepositoryTest {
    ...
    @Test
    @DisplayName("Deveria devolver null, quando unico médico cadastrado não está dispinivel na data")
